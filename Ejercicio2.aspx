<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ejercicio2.aspx.cs" Inherits="WebApplicationProgra2Evaluacion2.Ejercicio2" %>
    ...
    <main>
        <div class="container py-4">
            <div class="bg-body-tertiary rounded-3 p-4">
                <h1 class="display-6 fw-bold text-center mb-4">Calculadora de salario</h1>
